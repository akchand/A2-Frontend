function getPhoto()
{
  var apigClient = apigClientFactory.newClient({
                     apiKey: "CNMbifnLeq5HU0pHOK2hg2yuR5srr3Aq2As4HDg5"
        });
    ...
    apigClient.searchGet(params, body , additionalParams).then(function(result){
        ...
        rdata.forEach( function(obj) {
            var img = new Image();
            img.src = "https://myalbumbucket.s3.us-east-1.amazonaws.com/"+obj;
...
function submitPhoto()
{
   ...
   var base64_image = convertImgBase64(img_file).then(
     ...
     var params = {"key" : img_file.name, "bucket" : "myalbumbucket", "Content-Type" : img_file.type + ";base64", "x-amz-meta-CustomLabels": mlabels,"Access-Control-Allow-Origin": '*', "Access-Control-Allow-Headers": '*', "Access-Control-Allow-Methods":'*'};
