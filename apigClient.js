...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://y509wv8afc.execute-api.us-east-1.amazonaws.com/go';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'x-amz-meta-CustomLabels', 'Access-Control-Allow-Origin', 'Content-Type', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketKeyPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-CustomLabels', 'Access-Control-Allow-Origin', 'Content-Type', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
